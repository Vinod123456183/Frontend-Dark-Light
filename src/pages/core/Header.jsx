...
const Header = () => {
  ...
  return (
    <div>
      <header className="  relative w-full flex  items-center justify- py-3  lg:py-4 px-1 lg-px-3 ">
        {/* <div className="fixe ">Loo</div> */}
        <div className="  justify-end flex w-full  lg:gap-2">
          <div className="bg-gradient p-2 flex items-center justify-center gap-4 px-3 rounded-xl">
